...
| 💬 **대화** | 그날 배운 20문장으로 **LLM과 회화 연습**하도록 유도하는 프롬프트 자동 생성 (복사 → ChatGPT·Claude·Gemini에 붙여넣기, 자유대화/롤플레이/인터뷰 시나리오) |

- **음성**: 🎬 **유튜브 원본 영상의 실제 음성** — 각 문장의 타임스탬프(`t`~`e`)로 원본을 재생하므로 기계음이 아니라 원어민 성우 그대로. 재생 속도 조절 가능(0.5×~1.5×)
